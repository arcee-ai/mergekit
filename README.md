...
- [LRP-Merge Colab Guide](#instructions-for-running-lrp-merge-on-google-colab)
- [Citation](#citation)
...
| [**LRP-Merge** (`lrp`)](README.md#lrp-merge-layer-wise-relevance-propagation-for-llm-merging)                         | Relevance propagation weights preservation.                          |    ≥2    |  ✓   | Preserving functionally critical weights using XAI.              |
